...
本文是**实验文档**，记录已完成实验的结果、消融与已排除方向。方法细节见 [`../docs/method.md`](../docs/method.md)；交接事项见 [`../../HANDOVER.md`](../../HANDOVER.md)。

> 本文合并自原 `report.md`、`object_pose_feedback_go.md`、`object_pose_pipeline_summary.md`、`object_point_pose_loss_current_summary.md`、`current_status.md`、`experiment_route.md`、`stage_report_sam3_tracking_geometry.md` 七份文档，原文见 git 历史。
...
**概念界定。** 本节的分支均作用于 Stage 2a 的 refiner，改变**每个物体的 `ΔT` 如何求得**，即发生在共识之前。§6.1 的共识侧变体则改变 `ΔT` 求得**之后如何合并**。
