...
def test_retained_reference_blend_is_anchored(
    monkeypatch,
) -> None:
    calls = []
    ...
    assert calls[0]["config"].preserve_reference
    assert results[0].role == REFERENCE_BLEND_ROLE
